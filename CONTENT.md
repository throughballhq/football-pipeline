...
- [ ] **Út 1. 9.** (po GW2) - *"Anatomy of our fixture model"* (evergreen E2
  povýšený na vydání - draft v šuplíku, refresh čísel z packu).
- [ ] **~pol. září** (po 3 odehraných kolech) - ⭐ *"The model wakes up"* -
  ...
  plánovaný od den 1.
- [ ] **Srpen/září, podmíněně** - *"£75m and the kindest run"* - Bruno
  Guimarães v Arsenalu očima dat (ownership křivka z našich snapshotů,
  template middy otázka). [POKUD se přestup oficiálně dokončí; do té doby
  ani řádek - voice pravidlo 8.]
...
- [ ] **Začátek prosince** - *"Festive congestion, by the numbers"* - prosinec
  = nejvíc zápasů v roce; co dělá nahuštění s xG a čistými konty. (Kotva ⚓)
...
- [ ] **Konec května** - ⭐ *"The Season in Data"* - ročenka, nejsdílitelnější
  kus roku, sběr odběratelů přes léto. (Kotva ⚓)
...
- [x] **E1 - "How to read xG (and when not to trust it)"** ✅ v šuplíku
  (`drafts/evergreen_e1.md`) - primární pojistka / mezinárodní pauza.
- [x] **E2 - "Anatomy of our fixture model"** ✅ v šuplíku
  (`drafts/evergreen_e2.md`) - povýšen na vydání ~1. 9., viz zásobník.
- [ ] **E3 (rezerva) - "Ownership is a market, not a scoreboard"** - dav,
  template a proč vysoké vlastnictví není doporučení; behavioral úhel.
  Napsat, až E1 odejde do světa.

## 3) Kalendář kotev ⚓ (ne obsah - připravenost)

| Kdy | Co | Poznámka |
|---|---|---|
| do ~12. 8. | Korektura Issue #0 | jediný blokující úkol |
| **13.-14. 8.** | **Launch: Issue #0** + distribuce (X, r/FantasyPL) | týden před deadlinem = špička zájmu; refresh čísel z čerstvého packu v den publikace |
| **20. 8.** | **První Gameweek Brief** (24 h před deadline GW1) | druhý úder + generálka rytmu; exkluzivní úhel: price movers ze snapshotů |
| 21. 8. 18:30 UK | GW1 deadline → **start týdenního rytmu** | My Team modul obživne po výkopu |
